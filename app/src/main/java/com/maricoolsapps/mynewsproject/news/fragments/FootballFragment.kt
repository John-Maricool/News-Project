...
@AndroidEntryPoint
class FootballFragment : Fragment(R.layout.fragment_sports), NewsRecyclerAdapter.onItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        repository.getNews("football").observe(viewLifecycleOwner, Observer {
