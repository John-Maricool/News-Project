...
@AndroidEntryPoint
class NigeriaFragment : Fragment(R.layout.fragment_sports), NewsRecyclerAdapter.onItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        repository.getNews("nigeria").observe(viewLifecycleOwner, Observer {
