...
@AndroidEntryPoint
class MusicFragment : Fragment(R.layout.fragment_sports), NewsRecyclerAdapter.onItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        repository.getNews("music").observe(viewLifecycleOwner, Observer {
