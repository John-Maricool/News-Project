...
@AndroidEntryPoint
class SportsFragment : Fragment(R.layout.fragment_sports), NewsRecyclerAdapter.onItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        repository.getNews("sports").observe(viewLifecycleOwner, Observer {
